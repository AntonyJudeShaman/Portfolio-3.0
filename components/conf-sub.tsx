...
export default function ConfSub() {
  return (
    <div className="mt-[3rem] overflow-hidden mx-auto items-center justify-center max-w-5xl" style={{overflowY:"hidden"}}>
          ...
          <div className="max-w-full text-lg md:text-left md:text-2xl md:leading-10 leading-6 dmsans mx-auto">
            <div className="max-w-xl p-6 rounded-md">
              ...
              <p className="text-xl mb-4">
                ...
                the subscription process, <span className="poppins text-teal-500"> please check your email for a
