  ...
  return (
    <div className="md:mt-[15rem] mt-[5rem] mx-auto items-center justify-center max-w-7xl">
      <div className="mx-auto items-center justify-center grid grid-cols-1 lg:grid-cols-2 max-w-6xl">
        ...
        <div className="md:text-xl mx-auto md:p-0 p-6 text-md md:leading-10 poppins dark:text-white/70 text-black/70 leading-6 max-w-2xl md:max-w-3xl lg:max-w-xl">
          <div className="max-w-full mx-auto">
            ...
            <span className="dark:text-teal-300 text-purple-500"> full-stack development.</span> From
            crafting intuitive user interfaces using modern frameworks like{" "}
            <span className="dark:text-teal-300 text-purple-500">Nextjs</span> to exploring the
            intricacies of server-side technologies such as
            <span className="dark:text-teal-300 text-purple-500"> Node.js,</span> I find joy in the
