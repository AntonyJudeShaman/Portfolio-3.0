                ...
                <Card key={project.name}>
                  <Link href="https://www.bindhomes.com/" target="_blank">
                    <article className="relative  group flex-col flex justify-center w-full h-full p-6 md:p-8">
                      <div className="flex items-center justify-between gap-2">
                        <div className="text-sm text-zinc-900 poppins dark:text-zinc-100">
                      ...
                      <p className="mt-4 leading-8 dmsans duration-1000 text-zinc-600 group-hover:text-zinc-700 dark:text-zinc-400 dark:group-hover:text-zinc-300">
                        ...
                        scrollable cards for elegant project display, while the
                        Contact page includes a business description and a
                        functional contact form. A seamless blend of design and
                        functionality for efficient project management and
                        client interaction.
                      </p>
                      <p className="relative z-10 mt-6 flex flex-wrap text-sm font-medium text-gray-500 dark:text-gray-400">
                        {projectData?.project?.topics?.map((topic, index) => (
                          <span
                            key={index}
                            className="my-1 poppins mr-2 px-3 py-1 inline-flex items-center rounded-full bg-slate-300 text-gray-800 dark:bg-slate-800 dark:text-gray-200 border border-gray-300 dark:border-gray-700"
                          >
                            <svg
